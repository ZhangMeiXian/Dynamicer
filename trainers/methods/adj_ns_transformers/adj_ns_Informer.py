"""
@ModuleName: non-stationary Informer
"""
import torch
import torch.nn as nn
from trainers.methods.ns_layers.Transformer_EncDec import Decoder, DecoderLayer, Encoder, EncoderLayer, ConvLayer
from trainers.methods.ns_layers.SelfAttention_Family import DSProbAttention, AttentionLayer
from trainers.methods.net_libs.embedder import DataEmbedding
    ...
    def __init__(self, configs):
        ...
        self.decoder = Decoder(
            [
                DecoderLayer(
                    AttentionLayer(
                        DSProbAttention(True, configs.factor, attention_dropout=configs.dropout,
