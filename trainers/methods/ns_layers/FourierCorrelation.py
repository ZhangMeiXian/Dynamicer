...
class FourierBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, seq_len, modes=0, mode_select_method='random', des=None):
        ...
        # get modes on frequency domain
        self.index = get_frequency_modes(self.seq_len, modes=modes, mode_select_method=mode_select_method)
    ...
    def compl_mul1d(self, input, weights):
        """
        complex multiplication for 1D input.
        """
    ...
    def forward(self, q, k, v, mask=None, tau=None, delta=None):
        ...
        forward
        """
        logger.info("Fourier Block for layer: {}".format(self.des))
        # size = [B, L, H, E]
        B, L, H, E = q.shape
        x = q.permute(0, 2, 3, 1)
